...
def interactive_infer_image(model, image,all_classes,all_parts, thresh,text_size,hole_scale,island_scale,semantic, device='gpu',refimg=None, reftxt=None, audio_pth=None, video_pth=None):
    t = []
